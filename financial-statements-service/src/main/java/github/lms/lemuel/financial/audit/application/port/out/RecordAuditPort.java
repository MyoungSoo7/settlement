package github.lms.lemuel.financial.audit.application.port.out;

import java.util.Map;

/**
 * 감사 기록 아웃바운드 포트 — 민감 관리 작업(DART 수집 트리거 등)을 audit_logs 에 남긴다.
 *
...
public interface RecordAuditPort {
     ...
     * @param resourceType 대상 리소스 종류 (예: DartSync)
     * @param resourceId   대상 식별자 (예: companies, statements-2026)
