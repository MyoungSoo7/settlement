...
/**
 * 부팅 시 + 매월 1회 audit_logs 월별 파티션 런웨이를 굴린다 — financial-statements-service(public).
 *
 ...
 * 때 호출해 미래 파티션을 굴린다(재배포·재기동 주기로 런웨이가 계속 갱신됨). ADR 0027.
 *
...
public class PartitionMaintenanceRunner implements ApplicationRunner {
    ...
    public PartitionMaintenanceRunner(
            ...
            // 네이티브 SQL 은 hibernate.default_schema 를 무시하므로 함수명을 명시 한정한다(financial=public).
