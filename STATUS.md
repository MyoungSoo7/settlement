...
- **최근 커밋:** `693936e87` feat(loan): 담보평가 실연동 + 금융자산담보 상품 — P2-7b, Phase 2 이월 전량 소진
...
- 테스트 클래스 **713개** (Testcontainers 통합테스트 포함) — `git ls-files '*/src/test/*Test.java' '*/src/test/*Tests.java' '*/src/test/*IT.java' | wc -l` → 713
