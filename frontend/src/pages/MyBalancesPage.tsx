 ...
 * 내 포인트·상품권.
 *
 * <p>두 잔액을 <b>합쳐 보여 주지 않는다.</b> 포인트와 상품권은 회계에서도 다른 부채 계정이고,
 * 유효기간과 사용 규칙도 다르다. 한 숫자로 합치면 "왜 이만큼밖에 못 쓰지"라는 질문에 답할 수 없다.
 *
...
export default function MyBalancesPage() {
  ...
  return (
    <main className="mx-auto max-w-2xl p-6 space-y-8">
      <header>
        <h1 className="text-2xl font-bold">내 포인트 · 상품권</h1>
        <p className="text-sm text-gray-500">
          결제 시 사용할 수 있는 잔액입니다. 포인트와 상품권은 유효기간과 사용 규칙이 달라 따로 표시합니다.
        </p>
      </header>
