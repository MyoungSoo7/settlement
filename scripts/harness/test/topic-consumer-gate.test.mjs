...
const PUBLISH_ONLY = new Map([
  ...
  // insurance 9종 (SPEC.md §5) — 계약 스키마도 아직 미편입
  ['lemuel.insurance.policy_issued', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
  ['lemuel.insurance.policy_status_changed', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
  ['lemuel.insurance.banca_rule_violated', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
  ['lemuel.insurance.commission_confirmed', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
  ['lemuel.insurance.commission_paid', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
  ['lemuel.insurance.commission_clawback_triggered', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
  ['lemuel.insurance.general_payout_requested', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
  ['lemuel.insurance.general_payout_paid', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
  ['lemuel.insurance.commission_monthly_closed', 'SPEC §5 발행 전용 — 계약 스키마 미편입'],
