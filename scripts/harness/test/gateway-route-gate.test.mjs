...
const NOT_ROUTED_BY_DESIGN = new Map([
  ['company-service/CompanyCollectAdminController', '뉴스 수집 트리거 — /admin/company/** 외부 미노출'],
  ['company-service/CompanyDocumentAdminController', '문서함 관리 — /admin/company/** 외부 미노출'],
  ['company-service/CompanyRegistrationAdminController', '기업 등록 — /admin/company/** 외부 미노출'],
  ['company-service/CompanyWorkforceImportAdminController', '고용현황 임포트 — /admin/company/** 외부 미노출'],
  ['company-service/ReputationAdminController', '평판 재계산 트리거 — /admin/company/** 외부 미노출'],
  ['company-service/SellerLinkAdminController', '셀러↔기업 연결 — /admin/company/** 외부 미노출'],
  ['market-service/MarketSyncAdminController', 'KRX 시세 수집 트리거 — /admin/market/** 외부 미노출'],
  ['common-data-service/CommonDataAdminController', '공공데이터 수집 트리거 — /admin/commondata/** 외부 미노출'],
  ['financial-statements-service/FinancialSyncAdminController', 'DART 수집 트리거 — /admin/financial/** 외부 미노출'],
  ['economics-service/EconomicsSyncAdminController', 'ECOS 수집 트리거 — /admin/economics/** 외부 미노출'],
]);
