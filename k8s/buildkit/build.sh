...
#
#   ./k8s/buildkit/build.sh settlement-service card-service
#   ./k8s/buildkit/build.sh frontend                 # 프론트엔드도 대상이다
#   ./k8s/buildkit/build.sh --all --wait             # 백엔드 17 + 프론트엔드
...
NS=build
REGISTRY=ghcr.io
IMAGE_BASE=myoungsoo7/settlement
...
# 이미지는 ghcr.io/myoungsoo7/settlement-frontend (ci.yml 의 FRONTEND_IMAGE 와 동일).
