package github.lms.lemuel.market.audit.adapter.out.persistence;
 ...
 *
 * <p>market-service 는 shared-common 미의존 위성이라 공통 audit 스택
 * (common.audit.AuditLogJpaEntity)을 재사용할 수 없어 컬럼 구성을 동일하게 복제한다
 * (V20260716100200__market_audit_logs.sql 표준).
 *
