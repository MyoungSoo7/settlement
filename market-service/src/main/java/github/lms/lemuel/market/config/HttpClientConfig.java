 ...
 *
 * <ul>
 *   <li>RestClient.Builder — web 스타터만으로는 등록되지 않는다 (KrxApiClient 가 base-url 을 얹음).
 ...
 *       shared-common 의 JacksonCompatConfig 를 쓰지 않는 서비스라 금융위 응답 파싱용으로 자체 제공</li>
 * </ul>
 */
@Configuration
public class HttpClientConfig {
    ...
    @Bean
    public ObjectMapper krxObjectMapper() {
