package github.lms.lemuel.company.audit.adapter.out.persistence;
 ...
 *   <li><b>실패 무해</b> — 기록 실패(직렬화·DB 오류)는 삼키고 warn 만 남긴다. 문서 업로드·수집 트리거 같은
 ...
 * </ul>
 *
 * <p>company 는 shared-common 을 의존하지만 제한 스캔(common.outbox 만)이라 공통 audit 스택을
