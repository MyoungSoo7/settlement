...
class DocumentRecordContractTest {
    ...
    void uploadCommand_differsByContent() {
        ...
        assertThat(a).isNotEqualTo(b).isNotEqualTo(null).isNotEqualTo("other-type");
    }
    ...
    void documentDownload_contract() {
        ...
        assertThat(a).isEqualTo(b).hasSameHashCodeAs(b);
        assertThat(a).isNotEqualTo(new DocumentDownload(d, new byte[]{7})).isNotEqualTo("x");
    ...
    void documentContent_contract() {
        ...
        assertThat(a).isEqualTo(b).hasSameHashCodeAs(b);
        assertThat(a).isNotEqualTo(new DocumentContent(d, new byte[]{6})).isNotEqualTo("x");
