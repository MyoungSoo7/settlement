-- V20260716303000: prune_processed_events 최소 보존 하한 가드(≥7일) — 크로스컷 DB 리뷰 F3 (investment)
--
-- [설계 근거]
...
--   삭제 로직·시그니처(무접두 스키마, p_retention 파라미터, DEFAULT 30일)는 기존(V20260715142000)과 동일 —
--   가드만 신규 추가한다.
