...
- **이벤트 계약-as-code (ADR 0024)**: cross-service 43개 토픽의 JSON Schema + 정본 샘플이
...
## 5. 이벤트 카탈로그 (cross-service 43개 계약 토픽)

계약 스키마·정본 샘플: `shared-common/src/testFixtures/resources/contracts/events/` (43개, ADR 0024).
