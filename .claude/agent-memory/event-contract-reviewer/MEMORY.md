...
- [card-service org/reputation consumers](project_card_service_org_reputation_consumers.md) — N-consumer commits can have <N contract tests; service-layer unit tests aren't contract tests; SPEC.md drift recurred
