...
```text
C:\Users\iamip\IdeaProjects\kubenetis\settlement\pwc\submission\outputs\shinsung-tongsang-ceo-pipeline\briefing.docx   ← 이미 생성됨 (브리핑 수정 후 재생성: node src/bin/render-briefing-docx.mjs C:\Users\iamip\IdeaProjects\kubenetis\settlement\pwc\submission\outputs\shinsung-tongsang-ceo-pipeline\briefing.md)
```
