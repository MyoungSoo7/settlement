...
```text
C:\Users\iamip\IdeaProjects\kubenetis\settlement\pwc\submission\outputs\naver-ceo-pipeline\briefing.docx   ← 이미 생성됨 (브리핑 수정 후 재생성: node src/bin/render-briefing-docx.mjs C:\Users\iamip\IdeaProjects\kubenetis\settlement\pwc\submission\outputs\naver-ceo-pipeline\briefing.md)
```
...
```powershell
node src/test/briefing-eval.mjs --signals-file "C:\Users\iamip\IdeaProjects\kubenetis\settlement\pwc\submission\outputs\naver-ceo-pipeline\diagnostic-packet.json" "C:\Users\iamip\IdeaProjects\kubenetis\settlement\pwc\submission\outputs\naver-ceo-pipeline\briefing.md"
```
