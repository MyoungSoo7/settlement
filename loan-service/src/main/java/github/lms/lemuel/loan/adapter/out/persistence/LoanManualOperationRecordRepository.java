...
public interface LoanManualOperationRecordRepository
        extends JpaRepository<LoanManualOperationRecord, String> {
     ...
     */
    @Modifying
    @Query(value = "INSERT INTO opslab.loan_manual_operation_idempotency "
