...
/**
 * 정산 검색용 통합 Document (Outbound Adapter)
...
public class SettlementSearchDocument {
    ...
    // Getters and Setters (전체 코드 생략 - 기존과 동일)
    ...
    public LocalDateTime getSettlementConfirmedAt() { return settlementConfirmedAt; }
    public void setSettlementConfirmedAt(LocalDateTime settlementConfirmedAt) { this.settlementConfirmedAt = settlementConfirmedAt; }
    ...
    public Boolean getHasRefund() { return hasRefund; }
    public void setHasRefund(Boolean hasRefund) { this.hasRefund = hasRefund; }
    ...
    public String getLatestRefundStatus() { return latestRefundStatus; }
    public void setLatestRefundStatus(String latestRefundStatus) { this.latestRefundStatus = latestRefundStatus; }
    public String getRefundReason() { return refundReason; }
    public void setRefundReason(String refundReason) { this.refundReason = refundReason; }
    public LocalDateTime getLatestRefundRequestedAt() { return latestRefundRequestedAt; }
    public void setLatestRefundRequestedAt(LocalDateTime latestRefundRequestedAt) { this.latestRefundRequestedAt = latestRefundRequestedAt; }
    public LocalDateTime getLatestRefundCompletedAt() { return latestRefundCompletedAt; }
    public void setLatestRefundCompletedAt(LocalDateTime latestRefundCompletedAt) { this.latestRefundCompletedAt = latestRefundCompletedAt; }
