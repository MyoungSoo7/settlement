...
/**
 * audit_logs 월별 파티션 런웨이 자동 유지 — settlement-service(public).
 *
...
public class PartitionMaintenanceScheduler {
    ...
    public PartitionMaintenanceScheduler(
            ...
            // 네이티브 SQL 은 hibernate.default_schema 를 무시하므로 함수명을 명시 한정한다(settlement=public).
    ...
    @SchedulerLock(name = "settlement-partition-ensure-monthly", lockAtMostFor = "PT10M")
