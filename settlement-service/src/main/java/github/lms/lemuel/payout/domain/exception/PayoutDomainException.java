...
/**
 * 출금(payout) 도메인 예외의 공통 베이스 — 이 바운디드 컨텍스트가 소유한다.
 *
 ...
 */
public abstract class PayoutDomainException extends BusinessException {

    protected PayoutDomainException(ErrorCode errorCode, String message) {
