...
/**
 * 원장(ledger) 도메인 예외의 공통 베이스 — 이 바운디드 컨텍스트가 소유한다.
 *
 ...
 */
public abstract class LedgerDomainException extends BusinessException {

    protected LedgerDomainException(ErrorCode errorCode, String message) {
